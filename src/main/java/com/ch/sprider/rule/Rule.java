...
public class Rule
{
	...
	public final static int CLASS = 0;//样式
	public final static int ID = 1;//id值
	public final static int SELECTION = 2;//标签
	public final static int ATTRIBUTE = 3;//元素参数名
